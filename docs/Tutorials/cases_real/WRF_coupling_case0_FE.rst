...
.. [#] Muñoz-Esparza, D., Kosović, B., Mirocha, J., & van Beeck, J. (2014). Bridging the transition from mesoscale to microscale turbulence in numerical weather prediction models. Boundary-Layer Meteorology, 153(3), 409-440.

.. [#] Muñoz-Esparza, D., Kosović, B., Van Beeck, J., & Mirocha, J. (2015). A stochastic perturbation method to generate inflow turbulence in large-eddy simulation models: Application to neutrally stratified atmospheric boundary layers. Physics of Fluids, 27(3), 035102.
