...
int hydro_coreAddFieldAttributes(char *fieldName, int isForcing) {
    ...
    field_metadata_t field_metadata[] = {
        ...
        {"TKE_0",       "m2 s-2",        "Specific turbulent kinetic energy of air at grid-filter scale", NULL},
        {"TKE_1",       "m2 s-2",        "Specific turbulent kinetic energy of air at canopy leaf scale", NULL},
